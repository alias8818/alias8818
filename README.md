...
The companion corpus indexes **377 canonical AI-generated research artifacts**. Current status: **382/382 pass packaging/provenance lint** and **3/382 pass strict claim/evidence audit**. The 3/377 number is not a rollout gap — it is the feature. I built the strict-audit gate and headline its failure rate on the project's front page, because the packaging/provenance lint alone would let readers over-trust the corpus.
